...
class ProfileModificationController
{
    private $database;
...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (empty($nom) || empty($prenom)) {
        ...
        $profileModificationController = new ProfileModificationController($database);

        $profileModificationController->updateProfile($email, $nom, $prenom);
    }
} else {
